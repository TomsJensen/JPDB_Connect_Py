...
This project (jpdb-connect-py) is essentially the same as various [other](https://github.com/kampffrosch94/jpdb-connect) JPDB Connect projects that have existed, but my goals in creating it were unique in two ways.
...
# Installation
Simply download the relevant executable from the ['releases' tab](https://github.com/TomsJensen/JPDB_Connect_Py/releases) and run it. You'll be prompted for your [JPDB API key](https://jpdb.io/settings#:~:text=API%20Key) on the first run upon which it will be stored locally for future uses.
